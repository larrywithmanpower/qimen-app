...
// 2026/04 確定免費可用：gemini-2.5-flash（15 RPM/1000 RPD）、gemini-2.5-flash-lite（限額最寬）。
// gemini-2.0-flash 已於 2026/03 退役；gemini-2.5-pro 自 2026/04 起多數來源指出已轉為 paid-only，故不列入。
// 未來若升級付費方案可再將 gemini-2.5-pro 加回末位作為高品質備援。
